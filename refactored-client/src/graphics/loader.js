...
import {
  ...
  create_brambles,
  create_windmill,
  create_windmill_wing,
  create_windmill_head,
  create_wheat,
  create_sign,
  create_seed,
  create_wood_fire,
  create_fire,
  create_big_fire_wood,
  create_pirate_sword,
  create_sugar_can,
  create_sword_wood,
  create_stonesword,
  ...
  create_coat,
  create_cap_scarf,
  create_christmas_hat,
  create_elf_hat,
  create_bandage,
  create_bread_oven,
  create_bread_light_up,
  create_furnace_on,
  create_bed,
  create_crab_loot,
  create_crab_spear,
  ...
  create_lockpick,
  create_dragon_heart,
  create_resurrection_ground,
  create_resurrection,
  create_resurrection_rotate,
  create_resurrection_hole,
  create_headtotem,
  create_amethyst_helmet,
  create_winter_hood,
  create_hood,
  create_peasant,
  create_crown_life,
  create_crab_crown,
  create_dragon_helmet,
  create_dragon_sword,
  create_dragon_cube,
  create_blue_orb,
  create_gemme_green,
  ...
  create_cookie,
  create_candy,
  create_ferrero_rocher,
  create_bread,
  create_fishfood,
  create_fishfood_cooked,
  create_divingmask,
  create_scales,
  create_superdivingsuit,
  create_plot,
  create_garland_inv,
  create_bridge,
  create_roof,
...
export function render_inventory() {

import { IMAGES, DUMP_IMAGES } from "../graphics/images";
import { _load_images, draw_fake_world, create_text } from "../graphics/flat";
import { canw, canh } from "../canvas";

export default function Loader(can, ctx, after_loading_stuff) {
  this.can = can;
  this.ctx = ctx;
  this.logo = {
    translate: {
  ...
  // console.log(after_loading_stuff);
